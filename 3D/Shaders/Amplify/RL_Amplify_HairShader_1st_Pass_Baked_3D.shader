...
Shader "Reallusion/Amplify/RL_HairShader_1st_Pass_Baked_3D"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			#endif //aseld
			half3 lightDir55_g855 = ase_worldlightDir;
			...
			half temp_output_40_0_g855 = _Translucency;
			half temp_output_6_0_g855 = saturate( ( ( dotResult15_g855 * ( 1.0 - temp_output_40_0_g855 ) ) + temp_output_40_0_g855 ) );
			half wrappedLambert74_g855 = temp_output_6_0_g855;
			half4 temp_output_13_0_g855 = ( ( smoothstepResult22_g856 * pow( saturate( ( 1.0 - ( dotResult16_g856 * dotResult16_g856 ) ) ) , specularPower237_g853 ) ) * _SpecularMultiplier * wrappedLambert74_g855 * _SpecularTint );
			...
			#endif //aselc
			half4 temp_output_263_0_g853 = ( ase_lightAtten * ( ( lerpResult36_g855 + ( ( temp_output_6_0_g855 + ( pow( ( max( ( 1.0 - abs( dotResult54_g855 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g855 ) , 0.0 ) ) , _RimPower ) * _RimTransmissionIntensity * wrappedLambert74_g855 ) ) * temp_output_32_0_g855 ) ) * ase_lightColor ) );
			...
			#ifdef UNITY_PASS_FORWARDBASE
				half4 staticSwitch250_g853 = ( temp_output_263_0_g853 + ( half4( indirectDiffuse53_g853 , 0.0 ) * temp_output_42_0_g853 * lerpResult180_g853 ) );
			#else
				half4 staticSwitch250_g853 = temp_output_263_0_g853;
			#endif
...
/*ASEBEGIN
Version=18935
1920;0;1920;1029;2529.874;483.0696;1;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;573;-759.7318,-401.0714;Inherit;False;1085.333;1589.565;;18;378;571;595;263;569;180;108;482;572;177;596;389;385;384;380;539;265;645;Specular Highlights;1,0.7932334,0.514151,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;162;345.7961,1470.618;Inherit;False;Property;_AlphaClip2;Alpha Clip;9;0;Create;False;0;0;0;False;0;False;0.15;1;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=CD605B5CA17FA01C0403CEB5ADEEC0ABF6562F9C