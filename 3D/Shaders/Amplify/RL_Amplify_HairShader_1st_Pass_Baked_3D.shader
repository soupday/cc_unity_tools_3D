...
Shader "Reallusion/Amplify/RL_HairShader_1st_Pass_Baked_3D"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			half4 temp_output_13_0_g855 = ( ( smoothstepResult22_g856 * pow( saturate( ( 1.0 - ( dotResult16_g856 * dotResult16_g856 ) ) ) , specularPower237_g853 ) ) * _SpecularMultiplier * lambertMask85_g855 * _SpecularTint );
			...
			half dotResult82_g855 = dot( temp_output_24_0_g855 , lightDIr80_g855 );
			...
			#endif //aselc
			half4 temp_output_296_0_g853 = ( ase_lightAtten * ( ( lerpResult36_g855 + ( ( saturate( ( ( dotResult82_g855 * ( 1.0 - temp_output_40_0_g855 ) ) + temp_output_40_0_g855 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g855 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g855 ) , 0.0 ) ) , _RimPower ) * _RimTransmissionIntensity * temp_output_84_0_g855 ) ) * temp_output_32_0_g855 ) ) * ase_lightColor ) );
			...
			#ifdef UNITY_PASS_FORWARDBASE
				half4 staticSwitch250_g853 = ( temp_output_296_0_g853 + ( half4( indirectDiffuse53_g853 , 0.0 ) * temp_output_42_0_g853 * lerpResult180_g853 ) );
			#else
				half4 staticSwitch250_g853 = temp_output_296_0_g853;
			#endif
...
/*ASEBEGIN
Version=18935
1938;7;1920;1011;2452.938;648.1126;2.125589;True;False
...
ASEEND*/
//CHKSM=05D6A595D5979DBB9E0A545F127086FF66B6C301