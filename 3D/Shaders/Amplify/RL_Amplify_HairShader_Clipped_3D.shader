...
Shader "Reallusion/Amplify/RL_HairShader_Clipped_3D"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			half dotResult82_g868 = dot( temp_output_24_0_g868 , lightDIr80_g868 );
			...
			#endif //aselc
			half4 temp_output_296_0_g866 = ( ase_lightAtten * ( ( lerpResult36_g868 + ( ( saturate( ( ( dotResult82_g868 * ( 1.0 - temp_output_40_0_g868 ) ) + temp_output_40_0_g868 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g868 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g868 ) , 0.0 ) ) , _RimPower ) * _RimTransmissionIntensity * temp_output_84_0_g868 ) ) * temp_output_32_0_g868 ) ) * ase_lightColor ) );
			...
			#ifdef UNITY_PASS_FORWARDBASE
				half4 staticSwitch250_g866 = ( temp_output_296_0_g866 + ( half4( indirectDiffuse53_g866 , 0.0 ) * temp_output_42_0_g866 * lerpResult180_g866 ) );
			#else
				half4 staticSwitch250_g866 = temp_output_296_0_g866;
			#endif
...
/*ASEBEGIN
Version=18935
1938;7;1920;1011;2562.258;595.7314;2.795243;True;False
...
ASEEND*/
//CHKSM=F8436D4B16284B55736162D0C70DDFCA426D8ADC