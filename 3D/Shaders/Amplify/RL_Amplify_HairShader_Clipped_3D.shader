...
Shader "Reallusion/Amplify/RL_HairShader_Clipped_3D"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			half4 break109_g846 = tex2D( _FlowMap, uv_FlowMap );
			half lerpResult123_g846 = lerp( break109_g846.g , ( 1.0 - break109_g846.g ) , _FlowMapFlipGreen);
			half3 appendResult98_g846 = (half3(break109_g846.r , lerpResult123_g846 , break109_g846.b));
			half3 flowTangent107_g846 = (WorldNormalVector( i , ( ( appendResult98_g846 * float3( 2,2,2 ) ) - float3( 1,1,1 ) ) ));
			float2 uv_NormalMap = i.uv_texcoord * _NormalMap_ST.xy + _NormalMap_ST.zw;
			half3 normal282 = UnpackScaleNormal( tex2D( _NormalMap, uv_NormalMap ), _NormalStrength );
			half3 worldNormal86_g846 = normalize( (WorldNormalVector( i , normal282 )) );
			float2 uv_IDMap = i.uv_texcoord * _IDMap_ST.xy + _IDMap_ST.zw;
			half idMap383 = tex2D( _IDMap, uv_IDMap ).r;
			half lerpResult81_g846 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
			half3 normalizeResult10_g847 = normalize( ( flowTangent107_g846 + ( worldNormal86_g846 * lerpResult81_g846 ) ) );
			half3 shiftedTangent119_g846 = normalizeResult10_g847;
			...
			#endif //aseld
			half3 lightDir55_g848 = ase_worldlightDir;
			half3 normalizeResult14_g849 = normalize( ( viewDIr52_g848 + lightDir55_g848 ) );
			half dotResult16_g849 = dot( shiftedTangent119_g846 , normalizeResult14_g849 );
			...
			half temp_output_233_0_g846 = max( ( 1.0 - smoothness594 ) , 0.001 );
			half specularPower237_g846 = ( max( ( ( 2.0 / ( temp_output_233_0_g846 * temp_output_233_0_g846 ) ) - 2.0 ) , 0.001 ) * _SpecularPowerScale );
			half3 temp_output_24_0_g848 = worldNormal86_g846;
			half dotResult15_g848 = dot( lightDir55_g848 , temp_output_24_0_g848 );
			half temp_output_40_0_g848 = _Translucency;
			half temp_output_6_0_g848 = saturate( ( ( dotResult15_g848 * ( 1.0 - temp_output_40_0_g848 ) ) + temp_output_40_0_g848 ) );
			half wrappedLambert74_g848 = temp_output_6_0_g848;
			half4 temp_output_13_0_g848 = ( ( smoothstepResult22_g849 * pow( saturate( ( 1.0 - ( dotResult16_g849 * dotResult16_g849 ) ) ) , specularPower237_g846 ) ) * _SpecularMultiplier * wrappedLambert74_g848 * _SpecularTint );
			...
			half4 temp_output_42_0_g846 = baseColor331;
			half4 temp_output_32_0_g848 = temp_output_42_0_g846;
			...
			half dotResult57_g848 = dot( viewDIr52_g848 , lightDir55_g848 );
			#if defined(LIGHTMAP_ON) && ( UNITY_VERSION < 560 || ( defined(LIGHTMAP_SHADOW_MIXING) && !defined(SHADOWS_SHADOWMASK) && defined(SHADOWS_SCREEN) ) )//aselc
			half4 ase_lightColor = 0;
			#else //aselc
			half4 ase_lightColor = _LightColor0;
			#endif //aselc
			half4 temp_output_262_0_g846 = ( ase_lightAtten * ( ( lerpResult36_g848 + ( ( temp_output_6_0_g848 + ( pow( ( max( ( 1.0 - abs( dotResult54_g848 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g848 ) , 0.0 ) ) , _RimPower ) * _RimTransmissionIntensity * wrappedLambert74_g848 ) ) * temp_output_32_0_g848 ) ) * ase_lightColor ) );
			UnityGI gi53_g846 = gi;
			float3 diffNorm53_g846 = WorldNormalVector( i , worldNormal86_g846 );
			gi53_g846 = UnityGI_Base( data, 1, diffNorm53_g846 );
			half3 indirectDiffuse53_g846 = gi53_g846.indirect.diffuse + diffNorm53_g846 * 0.0001;
			half ambientOcclusion570 = ( 1.0 - ( _AOStrength * ( 1.0 - tex2DNode115.g ) ) );
			half temp_output_161_0_g846 = ambientOcclusion570;
			half temp_output_178_0_g846 = _AOOccludeAll;
			half lerpResult180_g846 = lerp( temp_output_161_0_g846 , 1.0 , temp_output_178_0_g846);
			#ifdef UNITY_PASS_FORWARDBASE
				half4 staticSwitch250_g846 = ( temp_output_262_0_g846 + ( half4( indirectDiffuse53_g846 , 0.0 ) * temp_output_42_0_g846 * lerpResult180_g846 ) );
			#else
				half4 staticSwitch250_g846 = temp_output_262_0_g846;
			#endif
			half lerpResult183_g846 = lerp( 1.0 , temp_output_161_0_g846 , temp_output_178_0_g846);
			...
			c.rgb = ( ( staticSwitch250_g846 * lerpResult183_g846 ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
			c.a = alpha518;
			return c;
		}
...
/*ASEBEGIN
Version=18935
7;24;1920;1005;1379.019;74.34729;1;True;False
...
WireConnection;626;42;572;0
WireConnection;626;161;571;0
WireConnection;626;178;108;0
WireConnection;626;84;569;0
WireConnection;626;131;378;0
WireConnection;626;7;595;0
WireConnection;626;172;482;0
WireConnection;626;132;380;0
WireConnection;626;245;596;0
WireConnection;626;108;177;0
WireConnection;626;112;180;0
WireConnection;626;71;384;0
WireConnection;626;75;385;0
WireConnection;626;80;389;0
WireConnection;626;200;539;0
WireConnection;626;207;265;0
WireConnection;626;208;263;0
WireConnection;518;0;23;0
WireConnection;528;1;162;0
WireConnection;528;0;175;0
WireConnection;574;0;626;0
...
ASEEND*/
//CHKSM=E9AD0D96009199BB0C4467488FC0E98CDDE72AEE