...
Shader "Reallusion/Amplify/RL_HairShader_Clipped_3D"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			half4 lerpResult41_g786 = lerp( float4( 1,1,1,0 ) , float4( 0,0,0,0 ) , 1.0);
			half temp_output_55_0_g786 = 0.0;
			half lerpResult50_g786 = lerp( temp_output_55_0_g786 , ( 1.0 - temp_output_55_0_g786 ) , 1.0);
			half4 lerpResult44_g786 = lerp( float4( 0.3294118,0.1411765,0.05098039,0 ) , float4( 0.6039216,0.454902,0.2862745,0 ) , lerpResult50_g786);
			half lerpResult43_g786 = lerp( 1.0 , 1.0 , lerpResult50_g786);
			half4 lerpResult53_g786 = lerp( lerpResult41_g786 , lerpResult44_g786 , ( lerpResult43_g786 * 1.0 ));
			...
			half lerpResult183_g866 = lerp( 1.0 , temp_output_161_0_g866 , _AOOccludeAll);
			half4 temp_output_182_0_g866 = ( ( ase_lightAtten * ( ( lerpResult36_g868 + ( ( saturate( ( ( dotResult82_g868 * ( 1.0 - temp_output_40_0_g868 ) ) + temp_output_40_0_g868 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g868 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g868 ) , 0.0 ) ) , _RimPower ) * _RimTransmissionIntensity * temp_output_84_0_g868 ) ) * temp_output_32_0_g868 ) ) * ase_lightColor ) ) * lerpResult183_g866 );
			...
			#ifdef UNITY_PASS_FORWARDBASE
				half4 staticSwitch250_g866 = ( temp_output_182_0_g866 + ( half4( indirectDiffuse53_g866 , 0.0 ) * temp_output_42_0_g866 * temp_output_161_0_g866 ) );
			#else
				half4 staticSwitch250_g866 = temp_output_182_0_g866;
			#endif
			...
			c.rgb = ( staticSwitch250_g866 + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
			c.a = alpha518;
			return c;
		}
...
/*ASEBEGIN
Version=18935
1920;0;1920;1029;7770.957;-50.90747;3.35696;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;637;-4950.334,253.3765;Inherit;False;Property;_HighlightBlend;Highlight Blend;32;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;95;-2929.674,-76.43671;Inherit;False;Property;BOOLEAN_ENABLECOLOR;Enable Color;44;0;Create;False;0;0;0;False;0;False;0;0;0;True;BOOLEAN_ENABLECOLOR_ON;Toggle;2;Key0;Key1;Create;True;False;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;632;-1204.654,138.827;Inherit;True;Property;_SpecularMap;Specular  Map;43;0;Create;True;0;0;0;False;0;False;19;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;265;-678.6436,998.7183;Inherit;False;Property;_RimTransmissionIntensity;Rim Transmission Intensity;48;0;Create;True;0;0;0;False;0;False;10;10;0;20;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;134;-1461.834,1309.566;Inherit;False;Property;_EmissiveColor;Emissive Color;42;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;133;-1503.434,1109.366;Inherit;True;Property;_EmissionMap;Emission Map;41;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=2C5AF6A139481853912482FD4B669CEE1FDB4B05