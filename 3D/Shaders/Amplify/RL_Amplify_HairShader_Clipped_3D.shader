...
Shader "Reallusion/Amplify/RL_HairShader_Clipped_3D"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			half4 break109_g866 = tex2D( _FlowMap, uv_FlowMap );
			half lerpResult123_g866 = lerp( break109_g866.g , ( 1.0 - break109_g866.g ) , _FlowMapFlipGreen);
			half3 appendResult98_g866 = (half3(break109_g866.r , lerpResult123_g866 , break109_g866.b));
			half3 flowTangent107_g866 = (WorldNormalVector( i , ( ( appendResult98_g866 * float3( 2,2,2 ) ) - float3( 1,1,1 ) ) ));
			...
			#endif //aseld
			half3 worldLight272_g866 = ase_worldlightDir;
			half dotResult266_g866 = dot( normalize( (WorldNormalVector( i , normal282 )) ) , worldLight272_g866 );
			half3 lerpResult269_g866 = lerp( normalize( (WorldNormalVector( i , normal282 )) ) , -normalize( (WorldNormalVector( i , normal282 )) ) , step( dotResult266_g866 , 0.0 ));
			half3 worldNormal86_g866 = lerpResult269_g866;
			float2 uv_IDMap = i.uv_texcoord * _IDMap_ST.xy + _IDMap_ST.zw;
			half idMap383 = tex2D( _IDMap, uv_IDMap ).r;
			half lerpResult81_g866 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
			half3 normalizeResult10_g867 = normalize( ( flowTangent107_g866 + ( worldNormal86_g866 * lerpResult81_g866 ) ) );
			half3 shiftedTangent119_g866 = normalizeResult10_g867;
			half3 ase_worldViewDir = Unity_SafeNormalize( UnityWorldSpaceViewDir( ase_worldPos ) );
			half3 viewDIr52_g868 = ase_worldViewDir;
			half3 lightDIr80_g868 = worldLight272_g866;
			half3 normalizeResult14_g869 = normalize( ( viewDIr52_g868 + lightDIr80_g868 ) );
			half dotResult16_g869 = dot( shiftedTangent119_g866 , normalizeResult14_g869 );
			half smoothstepResult22_g869 = smoothstep( -1.0 , 0.0 , dotResult16_g869);
			...
			half temp_output_233_0_g866 = max( ( 1.0 - smoothness594 ) , 0.001 );
			half specularPower237_g866 = ( max( ( ( 2.0 / ( temp_output_233_0_g866 * temp_output_233_0_g866 ) ) - 2.0 ) , 0.001 ) * _SpecularPowerScale );
			float2 uv_SpecularMap = i.uv_texcoord * _SpecularMap_ST.xy + _SpecularMap_ST.zw;
			half translucencyWrap283_g866 = _Translucency;
			half lambertMask290_g866 = saturate( ( ( dotResult266_g866 * ( 1.0 - translucencyWrap283_g866 ) ) + translucencyWrap283_g866 ) );
			half temp_output_84_0_g868 = lambertMask290_g866;
			half lambertMask85_g868 = temp_output_84_0_g868;
			half4 temp_output_13_0_g868 = ( ( smoothstepResult22_g869 * pow( saturate( ( 1.0 - ( dotResult16_g869 * dotResult16_g869 ) ) ) , specularPower237_g866 ) ) * ( tex2D( _SpecularMap, uv_SpecularMap ).g * _SpecularMultiplier ) * lambertMask85_g868 * _SpecularTint );
			float2 uv_BlendMap = i.uv_texcoord * _BlendMap_ST.xy + _BlendMap_ST.zw;
			half4 diffuseMap517 = tex2DNode19;
			half4 color10_g786 = IsGammaSpace() ? half4(1,1,1,0) : half4(1,1,1,0);
			half4 lerpResult18_g786 = lerp( color10_g786 , diffuseMap517 , _BaseColorStrength);
			float2 uv_RootMap = i.uv_texcoord * _RootMap_ST.xy + _RootMap_ST.zw;
			half root58 = tex2D( _RootMap, uv_RootMap ).r;
			half temp_output_27_0_g786 = root58;
			half lerpResult23_g786 = lerp( temp_output_27_0_g786 , ( 1.0 - temp_output_27_0_g786 ) , _InvertRootMap);
			half4 lerpResult3_g786 = lerp( _RootColor , _EndColor , lerpResult23_g786);
			half4 lerpResult6_g786 = lerp( lerpResult18_g786 , lerpResult3_g786 , ( _GlobalStrength * ( ( ( 1.0 - temp_output_27_0_g786 ) * _RootColorStrength ) + ( temp_output_27_0_g786 * _EndColorStrength ) ) ));
			...
			half lerpResult16_g788 = lerp( ( 1.0 - temp_output_24_0_g788 ) , temp_output_24_0_g788 , _HighlightAOverlapInvert);
			half4 lerpResult18_g788 = lerp( lerpResult6_g786 , _HighlightAColor , saturate( ( localThreePointDistribution8_g788 * ( 1.0 - ( _HighlightAOverlapEnd * ( 1.0 - lerpResult16_g788 ) ) ) ) ));
			...
			half lerpResult16_g789 = lerp( ( 1.0 - temp_output_24_0_g789 ) , temp_output_24_0_g789 , _HighlightBOverlapInvert);
			half4 lerpResult18_g789 = lerp( lerpResult18_g788 , _HighlightBColor , saturate( ( localThreePointDistribution8_g789 * ( 1.0 - ( _HighlightBOverlapEnd * ( 1.0 - lerpResult16_g789 ) ) ) ) ));
			...
			half4 temp_output_42_0_g866 = baseColor331;
			half4 temp_output_32_0_g868 = temp_output_42_0_g866;
			half4 lerpResult36_g868 = lerp( temp_output_13_0_g868 , ( temp_output_13_0_g868 * temp_output_32_0_g868 ) , _SpecularMix);
			half3 temp_output_24_0_g868 = worldNormal86_g866;
			half dotResult82_g868 = dot( lightDIr80_g868 , temp_output_24_0_g868 );
			half temp_output_40_0_g868 = translucencyWrap283_g866;
			half dotResult54_g868 = dot( temp_output_24_0_g868 , viewDIr52_g868 );
			half dotResult57_g868 = dot( viewDIr52_g868 , lightDIr80_g868 );
			#if defined(LIGHTMAP_ON) && ( UNITY_VERSION < 560 || ( defined(LIGHTMAP_SHADOW_MIXING) && !defined(SHADOWS_SHADOWMASK) && defined(SHADOWS_SCREEN) ) )//aselc
			half4 ase_lightColor = 0;
			#else //aselc
			half4 ase_lightColor = _LightColor0;
			#endif //aselc
			half4 temp_output_297_0_g866 = ( ase_lightAtten * ( ( lerpResult36_g868 + ( ( saturate( ( ( dotResult82_g868 * ( 1.0 - temp_output_40_0_g868 ) ) + temp_output_40_0_g868 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g868 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g868 ) , 0.0 ) ) , _RimPower ) * _RimTransmissionIntensity * temp_output_84_0_g868 ) ) * temp_output_32_0_g868 ) ) * ase_lightColor ) );
			UnityGI gi53_g866 = gi;
			float3 diffNorm53_g866 = WorldNormalVector( i , worldNormal86_g866 );
			gi53_g866 = UnityGI_Base( data, 1, diffNorm53_g866 );
			half3 indirectDiffuse53_g866 = gi53_g866.indirect.diffuse + diffNorm53_g866 * 0.0001;
			half ambientOcclusion570 = ( 1.0 - ( _AOStrength * ( 1.0 - tex2DNode115.g ) ) );
			half temp_output_161_0_g866 = ambientOcclusion570;
			half temp_output_178_0_g866 = _AOOccludeAll;
			half lerpResult180_g866 = lerp( temp_output_161_0_g866 , 1.0 , temp_output_178_0_g866);
			#ifdef UNITY_PASS_FORWARDBASE
				half4 staticSwitch250_g866 = ( temp_output_297_0_g866 + ( half4( indirectDiffuse53_g866 , 0.0 ) * temp_output_42_0_g866 * lerpResult180_g866 ) );
			#else
				half4 staticSwitch250_g866 = temp_output_297_0_g866;
			#endif
			half lerpResult183_g866 = lerp( 1.0 , temp_output_161_0_g866 , temp_output_178_0_g866);
			...
			c.rgb = ( ( staticSwitch250_g866 * lerpResult183_g866 ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
			c.a = alpha518;
			return c;
		}
...
/*ASEBEGIN
Version=18935
1920;0;1920;1029;2056.121;419.3207;1;True;False
...
Node;AmplifyShaderEditor.ColorNode;31;-5612.955,-600.91;Inherit;False;Property;_RootColor;Root Color;27;0;Create;True;0;0;0;False;0;False;0.3294118,0.1411765,0.05098039,0;0.3294117,0.1411764,0.05098034,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;32;-5612.805,-421.4388;Inherit;False;Property;_EndColor;End Color;28;0;Create;True;0;0;0;False;0;False;0.6039216,0.454902,0.2862745,0;0.6039216,0.454902,0.2862744,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;522;-4431.044,-426.122;Inherit;False;RL_Amplify_Function_Hair_IDBlend;-1;;788;6afb608343a58854589726462adfdb8b;0;8;26;COLOR;1,1,1,0;False;24;FLOAT;0.5;False;27;FLOAT;0.5;False;25;COLOR;0.9137256,0.7803922,0.6352941,0;False;21;FLOAT;1;False;20;FLOAT3;0.1,0.2,0.3;False;22;FLOAT;1;False;23;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;524;-3805.556,-56.1289;Inherit;False;RL_Amplify_Function_Hair_IDBlend;-1;;789;6afb608343a58854589726462adfdb8b;0;8;26;COLOR;1,1,1,0;False;24;FLOAT;0.5;False;27;FLOAT;0.5;False;25;COLOR;0.9137256,0.7803922,0.6352941,0;False;21;FLOAT;1;False;20;FLOAT3;0.1,0.2,0.3;False;22;FLOAT;1;False;23;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StaticSwitch;95;-2929.674,-76.43671;Inherit;False;Property;BOOLEAN_ENABLECOLOR;Enable Color;43;0;Create;False;0;0;0;False;0;False;0;0;0;True;BOOLEAN_ENABLECOLOR_ON;Toggle;2;Key0;Key1;Create;True;False;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;116;-1849.578,2316.963;Inherit;False;Property;_AOStrength;Ambient Occlusion Strength;13;0;Create;False;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;573;-759.7318,-401.0714;Inherit;False;1073.37;1585.308;;17;378;108;572;569;263;595;482;571;596;265;389;177;539;385;180;384;634;Specular Highlights;1,0.7932334,0.514151,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;380;-1191.927,329.3215;Inherit;False;Property;_SpecularMultiplier;Specular Strength;49;0;Create;False;0;0;0;False;0;False;1;0.5;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;632;-1204.654,138.827;Inherit;True;Property;_SpecularMap;Specular  Map;42;0;Create;True;0;0;0;False;0;False;19;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;389;-681.8292,847.2004;Inherit;False;Property;_SpecularShiftMax;Specular Shift Max;53;0;Create;True;0;0;0;False;0;False;0.25;0.25;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;482;-691.7015,199.9869;Inherit;False;Property;_SpecularMix;Specular Mix;51;0;Create;True;0;0;0;False;0;False;1;0.5;0.5;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;265;-678.6436,998.7183;Inherit;False;Property;_RimTransmissionIntensity;Rim Transmission Intensity;47;0;Create;True;0;0;0;False;0;False;10;10;0;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;263;-676.3562,1073.421;Inherit;False;Property;_RimPower;Rim Hardness;46;0;Create;False;0;0;0;False;0;False;4;2.5;1;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;539;-679.4417,923.2449;Inherit;False;Property;_Translucency;Translucency;54;0;Create;True;0;0;0;False;0;False;0;0.15;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;569;-590.8998,-125.8811;Inherit;False;282;normal;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;596;-689.4732,354.8531;Inherit;False;Property;_SpecularPowerScale;Specular Smoothness;50;0;Create;False;0;0;0;False;0;False;2;2;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;378;-628.2301,-49.07933;Inherit;False;Property;_SpecularTint;Specular Tint;48;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;177;-709.0319,429.8401;Inherit;True;Property;_FlowMap;Flow Map;44;0;Create;True;0;0;0;False;0;False;19;None;None;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;180;-627.6543,619.2548;Inherit;False;Property;_FlowMapFlipGreen;Flow Map Flip Green;45;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;385;-684.1522,771.6683;Inherit;False;Property;_SpecularShiftMin;Specular Shift Min;52;0;Create;True;0;0;0;False;0;False;-0.25;-0.25;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClipNode;608;810.1954,1249.929;Inherit;False;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;597;1078.876,1072.732;Half;False;True;-1;2;Reallusion.Import.CustomHairShaderGUI;0;0;CustomLighting;Reallusion/Amplify/RL_HairShader_Clipped_3D;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Off;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;1;True;True;0;True;Opaque;;AlphaTest;All;18;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;3;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;631;42;572;0
WireConnection;631;161;571;0
WireConnection;631;178;108;0
WireConnection;631;84;569;0
WireConnection;631;131;378;0
WireConnection;631;7;595;0
WireConnection;631;172;482;0
WireConnection;631;132;634;0
WireConnection;631;245;596;0
WireConnection;631;108;177;0
WireConnection;631;112;180;0
WireConnection;631;71;384;0
WireConnection;631;75;385;0
WireConnection;631;80;389;0
WireConnection;631;282;539;0
WireConnection;631;207;265;0
WireConnection;631;208;263;0
WireConnection;135;0;133;0
WireConnection;135;1;134;0
WireConnection;574;0;631;0
...
ASEEND*/
//CHKSM=E1AEE3338F1AC46D71CF4A45B45070EBF0754706