...
Shader "Reallusion/Amplify/RL_HairShader_2nd_Pass_Baked_3D"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			half3 worldNormal86_g849 = normalize( (WorldNormalVector( i , normal282 )) );
			...
			#endif //aseld
			half3 lightDir55_g851 = ase_worldlightDir;
			...
			half temp_output_40_0_g851 = _Translucency;
			half temp_output_6_0_g851 = saturate( ( ( dotResult15_g851 * ( 1.0 - temp_output_40_0_g851 ) ) + temp_output_40_0_g851 ) );
			half wrappedLambert74_g851 = temp_output_6_0_g851;
			half4 temp_output_13_0_g851 = ( ( smoothstepResult22_g852 * pow( saturate( ( 1.0 - ( dotResult16_g852 * dotResult16_g852 ) ) ) , specularPower237_g849 ) ) * _SpecularMultiplier * wrappedLambert74_g851 * _SpecularTint );
			...
			#endif //aselc
			half4 temp_output_263_0_g849 = ( ase_lightAtten * ( ( lerpResult36_g851 + ( ( temp_output_6_0_g851 + ( pow( ( max( ( 1.0 - abs( dotResult54_g851 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g851 ) , 0.0 ) ) , _RimPower ) * _RimTransmissionIntensity * wrappedLambert74_g851 ) ) * temp_output_32_0_g851 ) ) * ase_lightColor ) );
			...
			#ifdef UNITY_PASS_FORWARDBASE
				half4 staticSwitch250_g849 = ( temp_output_263_0_g849 + ( half4( indirectDiffuse53_g849 , 0.0 ) * temp_output_42_0_g849 * lerpResult180_g849 ) );
			#else
				half4 staticSwitch250_g849 = temp_output_263_0_g849;
			#endif
		...
		ENDCG
		CGPROGRAM
		#pragma surface surf StandardCustomLighting alpha:fade keepalpha fullforwardshadows  alpha:blend
...
/*ASEBEGIN
Version=18935
1920;0;1920;1029;2555.398;400.3415;1.155376;True;False
...
Node;AmplifyShaderEditor.ColorNode;634;-1399.275,1353.574;Inherit;False;Property;_EmissionColor;Emission Color;10;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;177;-709.0319,429.8401;Inherit;True;Property;_FlowMap;Flow Map;13;0;Create;True;0;0;0;False;0;False;19;None;None;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;645;1031.346,1247.088;Half;False;True;-1;2;ASEMaterialInspector;0;0;CustomLighting;Reallusion/Amplify/RL_HairShader_2nd_Pass_Baked_3D;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;False;False;False;False;False;Off;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Transparent;0.5;True;True;0;False;Transparent;;Transparent;All;18;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;1;alpha:blend;0;False;0.1;False;-1;0;False;-1;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=F135838B8E101BA6019D6C3F4BFD79060FF02939