...
Shader "Reallusion/Amplify/RL_HairShader_2nd_Pass_Baked_3D"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			half lerpResult183_g849 = lerp( 1.0 , temp_output_161_0_g849 , _AOOccludeAll);
			half4 temp_output_182_0_g849 = ( ( ase_lightAtten * ( ( lerpResult36_g851 + ( ( saturate( ( ( dotResult82_g851 * ( 1.0 - temp_output_40_0_g851 ) ) + temp_output_40_0_g851 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g851 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g851 ) , 0.0 ) ) , _RimPower ) * _RimTransmissionIntensity * temp_output_84_0_g851 ) ) * temp_output_32_0_g851 ) ) * ase_lightColor ) ) * lerpResult183_g849 );
			...
			#ifdef UNITY_PASS_FORWARDBASE
				half4 staticSwitch250_g849 = ( temp_output_182_0_g849 + ( half4( indirectDiffuse53_g849 , 0.0 ) * temp_output_42_0_g849 * temp_output_161_0_g849 ) );
			#else
				half4 staticSwitch250_g849 = temp_output_182_0_g849;
			#endif
			float2 uv_EmissionMap = i.uv_texcoord * _EmissionMap_ST.xy + _EmissionMap_ST.zw;
			clip( alpha518 - 0.05);
			c.rgb = ( staticSwitch250_g849 + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissionColor ) ).rgb;
...
/*ASEBEGIN
Version=18935
1920;0;1920;1029;2239.797;-1771.633;1;True;False
...
ASEEND*/
//CHKSM=83086DABBB9AA55CE63732405FE539E799EE9A5A