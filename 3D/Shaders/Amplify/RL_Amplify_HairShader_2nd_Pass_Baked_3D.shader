...
Shader "Reallusion/Amplify/RL_HairShader_2nd_Pass_Baked_3D"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			half4 temp_output_13_0_g851 = ( ( smoothstepResult22_g852 * pow( saturate( ( 1.0 - ( dotResult16_g852 * dotResult16_g852 ) ) ) , specularPower237_g849 ) ) * _SpecularMultiplier * lambertMask85_g851 * _SpecularTint );
			...
			half dotResult82_g851 = dot( temp_output_24_0_g851 , lightDIr80_g851 );
			...
			#endif //aselc
			half4 temp_output_296_0_g849 = ( ase_lightAtten * ( ( lerpResult36_g851 + ( ( saturate( ( ( dotResult82_g851 * ( 1.0 - temp_output_40_0_g851 ) ) + temp_output_40_0_g851 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g851 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g851 ) , 0.0 ) ) , _RimPower ) * _RimTransmissionIntensity * temp_output_84_0_g851 ) ) * temp_output_32_0_g851 ) ) * ase_lightColor ) );
			...
			#ifdef UNITY_PASS_FORWARDBASE
				half4 staticSwitch250_g849 = ( temp_output_296_0_g849 + ( half4( indirectDiffuse53_g849 , 0.0 ) * temp_output_42_0_g849 * lerpResult180_g849 ) );
			#else
				half4 staticSwitch250_g849 = temp_output_296_0_g849;
			#endif
...
/*ASEBEGIN
Version=18935
1938;7;1920;1011;1175.376;142.4399;1.075835;True;False
...
ASEEND*/
//CHKSM=B1CD28EBF2CAAA56933527178C8D092E654F1C48