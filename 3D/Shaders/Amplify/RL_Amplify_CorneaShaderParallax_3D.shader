...
Shader "Reallusion/Amplify/RL_CorneaShaderParallax_3D"
{
	...
	SubShader
	{
		...
		uniform float _DepthRadius;
		uniform float _IOR;
		uniform float _PMod;
		uniform float _ParallaxRadius;
		uniform float _IrisSaturation;
		uniform float _IrisBrightness;
		uniform float _LimbusDarkRadius;
		uniform float _LimbusDarkWidth;
		...
		uniform float _IrisSubsurfaceScale;
		uniform float _ScleraSubsurfaceScale;
		...
		void surf( Input i , inout SurfaceOutputStandardCustom o )
		{
			...
			float radial203 = length( ( i.uv_texcoord - float2( 0.5,0.5 ) ) );
			...
			float2 temp_cast_2 = (( ( 1.0 - temp_output_88_0 ) * 0.5 )).xx;
			float2 uv_TexCoord93 = i.uv_texcoord * temp_cast_1 + temp_cast_2;
			float3 ase_worldNormal = WorldNormalVector( i, float3( 0, 0, 1 ) );
			float3 ase_worldTangent = WorldNormalVector( i, float3( 1, 0, 0 ) );
			float3 ase_worldBitangent = WorldNormalVector( i, float3( 0, 1, 0 ) );
			float3x3 ase_worldToTangent = float3x3( ase_worldTangent, ase_worldBitangent, ase_worldNormal );
			float3 normalizeResult117 = normalize( ( ( mul( ase_worldToTangent, ase_worldNormal ) * ( _IOR - 0.8 ) ) + i.viewDir ) );
			...
			float2 lerpResult136 = lerp( uv_TexCoord93 , (( uv_TexCoord93 - ( (normalizeResult117).xy * _IrisDepth ) )*temp_output_122_0 + ( ( 1.0 - temp_output_122_0 ) * 0.5 )) , pow( saferPower157 , 0.25 ));
			...
			float2 temp_cast_5 = (temp_output_223_0).xx;
			float2 temp_cast_6 = (( ( 1.0 - temp_output_223_0 ) * 0.5 )).xx;
			float2 uv_TexCoord228 = i.uv_texcoord * temp_cast_5 + temp_cast_6;
			float3 hsvTorgb231 = RGBToHSV( tex2D( _ScleraDiffuseMap, uv_TexCoord228 ).rgb );
			...
			float4 temp_output_21_0 = ( saturate( lerpBlendMode21 ));
			...
			float4 baseColor370 = temp_output_21_0;
...
/*ASEBEGIN
Version=18935
1919;-4;1920;993;2026.691;-2105.208;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;72;-6116.004,121.286;Inherit;False;Property;_IrisDepth;Iris Depth;33;0;Create;True;0;0;0;False;0;False;0.3;0.004;0.1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;73;-6777.356,-974.6068;Inherit;False;Property;_PupilScale;Pupil Scale;32;0;Create;True;0;0;0;False;0;False;0.8;0.8;0.1;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;243;-4067.687,-1193.44;Inherit;False;Property;_ShadowRadius;Shadow Radius;15;0;Create;True;0;0;0;False;0;False;0.275;0.275;0;0.5;0;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;249;-4142.133,-1326.678;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;242;-4069.911,-1423.21;Inherit;False;Property;_ShadowHardness;Shadow Hardness;16;0;Create;True;0;0;0;False;0;False;0.5;0.5;0.01;0.99;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;49;-2555.033,-1620.931;Inherit;False;Property;_CornerShadowColor;Corner Shadow Color;17;0;Create;True;0;0;0;False;0;False;1,0.7333333,0.6980392,0;1,0.7333333,0.6980392,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;20;-1185.414,-308.748;Inherit;False;Property;_ColorBlendStrength;Color Blend Strength;26;0;Create;True;0;0;0;False;0;False;0.2;0.2;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;338;-1195.414,2984.79;Inherit;False;Property;_SubsurfaceFalloff;Subsurface Falloff;20;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;302;-1257.718,2701.489;Inherit;False;Property;_ScleraSubsurfaceScale;Sclera Subsurface Scale;18;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;279;-1387.606,2054.369;Inherit;False;Property;_AOStrength;Ambient Occlusion Strength;22;0;Create;False;0;0;0;False;0;False;0.2;0.2;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;314;-1258.675,2615.98;Inherit;False;Property;_IrisSubsurfaceScale;Iris Subsurface Scale;19;0;Create;True;0;0;0;False;0;False;0;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;270;-1187.958,1532.285;Inherit;False;Property;_ScleraSmoothness;Sclera Smoothness;23;0;Create;True;0;0;0;False;0;False;0.8;0.7;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;325;-2726.429,1963.902;Inherit;False;Property;_IsLeftEye;Is Left Eye;38;1;[Toggle];Create;True;0;0;0;True;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;376;500.1655,949.3455;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;369;996.8561,720.2521;Float;False;True;-1;2;ASEMaterialInspector;0;0;Standard;Reallusion/Amplify/RL_CorneaShaderParallax_3D;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;ForwardOnly;18;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;40;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=24B8F0739C3962558538193C3E48CA8A504EC568