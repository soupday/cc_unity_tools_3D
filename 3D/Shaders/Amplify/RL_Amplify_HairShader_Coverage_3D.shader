...
Shader "Reallusion/Amplify/RL_HairShader_Coverage_3D"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			half3 worldNormal86_g830 = normalize( (WorldNormalVector( i , normal282 )) );
			...
			#endif //aseld
			half3 lightDir55_g832 = ase_worldlightDir;
			half3 normalizeResult14_g833 = normalize( ( viewDIr52_g832 + lightDir55_g832 ) );
			...
			half dotResult15_g832 = dot( lightDir55_g832 , temp_output_24_0_g832 );
			half temp_output_40_0_g832 = _Tranlucency;
			half temp_output_6_0_g832 = saturate( ( ( dotResult15_g832 * ( 1.0 - temp_output_40_0_g832 ) ) + temp_output_40_0_g832 ) );
			half wrappedLambert74_g832 = temp_output_6_0_g832;
			half4 temp_output_13_0_g832 = ( ( smoothstepResult22_g833 * pow( saturate( ( 1.0 - ( dotResult16_g833 * dotResult16_g833 ) ) ) , specularPower237_g830 ) ) * _SpecularMultiplier * wrappedLambert74_g832 * _SpecularTint );
			...
			half dotResult57_g832 = dot( viewDIr52_g832 , lightDir55_g832 );
			#if defined(LIGHTMAP_ON) && ( UNITY_VERSION < 560 || ( defined(LIGHTMAP_SHADOW_MIXING) && !defined(SHADOWS_SHADOWMASK) && defined(SHADOWS_SCREEN) ) )//aselc
			half4 ase_lightColor = 0;
			#else //aselc
			half4 ase_lightColor = _LightColor0;
			#endif //aselc
			half4 temp_output_261_0_g830 = ( ase_lightAtten * ( ( lerpResult36_g832 + ( ( temp_output_6_0_g832 + ( pow( ( max( ( 1.0 - abs( dotResult54_g832 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g832 ) , 0.0 ) ) , _RimPower ) * _RimTransmissionIntensity * wrappedLambert74_g832 ) ) * temp_output_32_0_g832 ) ) * ase_lightColor ) );
			...
			#ifdef UNITY_PASS_FORWARDBASE
				half4 staticSwitch250_g830 = ( temp_output_261_0_g830 + ( half4( indirectDiffuse53_g830 , 0.0 ) * temp_output_42_0_g830 * lerpResult180_g830 ) );
			#else
				half4 staticSwitch250_g830 = temp_output_261_0_g830;
			#endif
...
/*ASEBEGIN
Version=18935
1913;23;1920;1005;985.4946;-797.3015;1.678264;True;False
...
ASEEND*/
//CHKSM=D131CF952B1C7F540AC8B7C0F796F0C02C055FEE