...
Shader "Reallusion/Amplify/RL_HairShader_Coverage_3D"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			#endif //aselc
			half4 temp_output_297_0_g830 = ( ase_lightAtten * ( ( lerpResult36_g832 + ( ( saturate( ( ( dotResult82_g832 * ( 1.0 - temp_output_40_0_g832 ) ) + temp_output_40_0_g832 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g832 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g832 ) , 0.0 ) ) , _RimPower ) * _RimTransmissionIntensity * temp_output_84_0_g832 ) ) * temp_output_32_0_g832 ) ) * ase_lightColor ) );
			...
			half temp_output_178_0_g830 = _AOOccludeAll;
			half lerpResult180_g830 = lerp( temp_output_161_0_g830 , 1.0 , temp_output_178_0_g830);
			#ifdef UNITY_PASS_FORWARDBASE
				half4 staticSwitch250_g830 = ( temp_output_297_0_g830 + ( half4( indirectDiffuse53_g830 , 0.0 ) * temp_output_42_0_g830 * lerpResult180_g830 ) );
			#else
				half4 staticSwitch250_g830 = temp_output_297_0_g830;
			#endif
			half lerpResult183_g830 = lerp( 1.0 , temp_output_161_0_g830 , temp_output_178_0_g830);
			float2 uv_EmissionMap = i.uv_texcoord * _EmissionMap_ST.xy + _EmissionMap_ST.zw;
			clip( alpha518 - _AlphaClip);
			c.rgb = ( ( staticSwitch250_g830 * lerpResult183_g830 ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
			c.a = alpha518;
			return c;
		}
...
/*ASEBEGIN
Version=18935
1920;0;1920;1029;2335.625;454.9074;1;True;False
...
Node;AmplifyShaderEditor.SamplerNode;625;-1195.632,147.6212;Inherit;True;Property;_SpecularMap;Specular  Map;42;0;Create;True;0;0;0;False;0;False;19;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;380;-1174.927,338.3215;Inherit;False;Property;_SpecularMultiplier;Specular Strength;47;0;Create;False;0;0;0;False;0;False;1;0.5;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;596;-691.4732,362.8531;Inherit;False;Property;_SpecularPowerScale;Specular Smoothness;48;0;Create;False;0;0;0;False;0;False;2;2;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;482;-691.7015,192.9869;Inherit;False;Property;_SpecularMix;Specular Mix;49;0;Create;True;0;0;0;False;0;False;1;0.5;0.5;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;177;-709.0319,429.8401;Inherit;True;Property;_FlowMap;Flow Map;41;0;Create;True;0;0;0;False;0;False;19;None;None;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;378;-627.2301,-49.07933;Inherit;False;Property;_SpecularTint;Specular Tint;46;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=6BE362B2B55CDA69DBBC263F557FFFA27DA70140