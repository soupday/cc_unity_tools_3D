...
Shader "Reallusion/Amplify/RL_HairShader_Coverage_3D"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			half dotResult82_g832 = dot( temp_output_24_0_g832 , lightDIr80_g832 );
			...
			#endif //aselc
			half4 temp_output_296_0_g830 = ( ase_lightAtten * ( ( lerpResult36_g832 + ( ( saturate( ( ( dotResult82_g832 * ( 1.0 - temp_output_40_0_g832 ) ) + temp_output_40_0_g832 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g832 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g832 ) , 0.0 ) ) , _RimPower ) * _RimTransmissionIntensity * temp_output_84_0_g832 ) ) * temp_output_32_0_g832 ) ) * ase_lightColor ) );
			...
			#ifdef UNITY_PASS_FORWARDBASE
				half4 staticSwitch250_g830 = ( temp_output_296_0_g830 + ( half4( indirectDiffuse53_g830 , 0.0 ) * temp_output_42_0_g830 * lerpResult180_g830 ) );
			#else
				half4 staticSwitch250_g830 = temp_output_296_0_g830;
			#endif
...
/*ASEBEGIN
Version=18935
1938;7;1920;1011;1362.729;206.8182;2.018425;True;False
...
ASEEND*/
//CHKSM=6AB1F4D637006B46381DC900AD28B3A04EC9F4D6