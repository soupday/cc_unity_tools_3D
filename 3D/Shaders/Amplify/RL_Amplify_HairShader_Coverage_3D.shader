...
Shader "Reallusion/Amplify/RL_HairShader_Coverage_3D"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			half4 break109_g830 = tex2D( _FlowMap, uv_FlowMap );
			half lerpResult123_g830 = lerp( break109_g830.g , ( 1.0 - break109_g830.g ) , _FlowMapFlipGreen);
			half3 appendResult98_g830 = (half3(break109_g830.r , lerpResult123_g830 , break109_g830.b));
			half3 flowTangent107_g830 = (WorldNormalVector( i , ( ( appendResult98_g830 * float3( 2,2,2 ) ) - float3( 1,1,1 ) ) ));
			...
			#endif //aseld
			half3 worldLight272_g830 = ase_worldlightDir;
			half dotResult266_g830 = dot( normalize( (WorldNormalVector( i , normal282 )) ) , worldLight272_g830 );
			half3 lerpResult269_g830 = lerp( normalize( (WorldNormalVector( i , normal282 )) ) , -normalize( (WorldNormalVector( i , normal282 )) ) , step( dotResult266_g830 , 0.0 ));
			half3 worldNormal86_g830 = lerpResult269_g830;
			float2 uv_IDMap = i.uv_texcoord * _IDMap_ST.xy + _IDMap_ST.zw;
			half idMap383 = tex2D( _IDMap, uv_IDMap ).r;
			half lerpResult81_g830 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
			half3 normalizeResult10_g831 = normalize( ( flowTangent107_g830 + ( worldNormal86_g830 * lerpResult81_g830 ) ) );
			half3 shiftedTangent119_g830 = normalizeResult10_g831;
			half3 ase_worldViewDir = Unity_SafeNormalize( UnityWorldSpaceViewDir( ase_worldPos ) );
			half3 viewDIr52_g832 = ase_worldViewDir;
			half3 lightDIr80_g832 = worldLight272_g830;
			half3 normalizeResult14_g833 = normalize( ( viewDIr52_g832 + lightDIr80_g832 ) );
			half dotResult16_g833 = dot( shiftedTangent119_g830 , normalizeResult14_g833 );
			half smoothstepResult22_g833 = smoothstep( -1.0 , 0.0 , dotResult16_g833);
			...
			half temp_output_233_0_g830 = max( ( 1.0 - smoothness594 ) , 0.001 );
			half specularPower237_g830 = ( max( ( ( 2.0 / ( temp_output_233_0_g830 * temp_output_233_0_g830 ) ) - 2.0 ) , 0.001 ) * _SpecularPowerScale );
			float2 uv_SpecularMap = i.uv_texcoord * _SpecularMap_ST.xy + _SpecularMap_ST.zw;
			half translucencyWrap283_g830 = _Translucency;
			half lambertMask290_g830 = saturate( ( ( dotResult266_g830 * ( 1.0 - translucencyWrap283_g830 ) ) + translucencyWrap283_g830 ) );
			half temp_output_84_0_g832 = lambertMask290_g830;
			half lambertMask85_g832 = temp_output_84_0_g832;
			half4 temp_output_13_0_g832 = ( ( smoothstepResult22_g833 * pow( saturate( ( 1.0 - ( dotResult16_g833 * dotResult16_g833 ) ) ) , specularPower237_g830 ) ) * ( tex2D( _SpecularMap, uv_SpecularMap ).g * _SpecularMultiplier ) * lambertMask85_g832 * _SpecularTint );
			...
			half3 From8_g836 = _HighlightBDistribution;
			half ID8_g836 = idMap383;
			half Fac8_g836 = _HighlightBStrength;
			...
			half lerpResult16_g836 = lerp( temp_output_24_0_g836 , ( 1.0 - temp_output_24_0_g836 ) , _HighlightBOverlapInvert);
			half4 lerpResult18_g836 = lerp( lerpResult18_g837 , _HighlightBColor , saturate( ( localThreePointDistribution8_g836 * ( 1.0 - ( _HighlightBOverlapEnd * lerpResult16_g836 ) ) * _HighlightBlend ) ));
			#ifdef BOOLEAN_ENABLECOLOR_ON
				half4 staticSwitch95 = lerpResult18_g836;
			#else
			...
			half4 temp_output_42_0_g830 = baseColor331;
			half4 temp_output_32_0_g832 = temp_output_42_0_g830;
			half4 lerpResult36_g832 = lerp( temp_output_13_0_g832 , ( temp_output_13_0_g832 * temp_output_32_0_g832 ) , _SpecularMix);
			half3 temp_output_24_0_g832 = worldNormal86_g830;
			half dotResult82_g832 = dot( lightDIr80_g832 , temp_output_24_0_g832 );
			half temp_output_40_0_g832 = translucencyWrap283_g830;
			half dotResult54_g832 = dot( temp_output_24_0_g832 , viewDIr52_g832 );
			half dotResult57_g832 = dot( viewDIr52_g832 , lightDIr80_g832 );
			...
			half temp_output_161_0_g830 = ambientOcclusion570;
			half lerpResult183_g830 = lerp( 1.0 , temp_output_161_0_g830 , _AOOccludeAll);
			half4 temp_output_182_0_g830 = ( ( ase_lightAtten * ( ( lerpResult36_g832 + ( ( saturate( ( ( dotResult82_g832 * ( 1.0 - temp_output_40_0_g832 ) ) + temp_output_40_0_g832 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g832 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g832 ) , 0.0 ) ) , _RimPower ) * _RimTransmissionIntensity * temp_output_84_0_g832 ) ) * temp_output_32_0_g832 ) ) * ase_lightColor ) ) * lerpResult183_g830 );
			UnityGI gi53_g830 = gi;
			float3 diffNorm53_g830 = WorldNormalVector( i , worldNormal86_g830 );
			gi53_g830 = UnityGI_Base( data, 1, diffNorm53_g830 );
			half3 indirectDiffuse53_g830 = gi53_g830.indirect.diffuse + diffNorm53_g830 * 0.0001;
			#ifdef UNITY_PASS_FORWARDBASE
				half4 staticSwitch250_g830 = ( temp_output_182_0_g830 + ( half4( indirectDiffuse53_g830 , 0.0 ) * temp_output_42_0_g830 * temp_output_161_0_g830 ) );
			#else
				half4 staticSwitch250_g830 = temp_output_182_0_g830;
			#endif
			float2 uv_EmissionMap = i.uv_texcoord * _EmissionMap_ST.xy + _EmissionMap_ST.zw;
			clip( alpha518 - _AlphaClip);
			c.rgb = ( staticSwitch250_g830 + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
			c.a = alpha518;
			return c;
		}
...
/*ASEBEGIN
Version=18935
1920;0;1920;1029;6949.799;1724.993;4.121803;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;634;-4942.078,243.9706;Inherit;False;Property;_HighlightBlend;Highlight Blend;32;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;125;-1707.221,1837.011;Inherit;False;Property;_SmoothnessMax;Smoothness Max;15;0;Create;True;0;0;0;False;0;False;1;0.897;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;116;-1859.673,2422.238;Inherit;False;Property;_AOStrength;Ambient Occlusion Strength;10;0;Create;False;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;20;-5663.463,1220.562;Inherit;False;Property;_AlphaRemap;Alpha Remap;8;0;Create;True;0;0;0;False;0;False;0.5;1;0.5;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;628;-1476.625,-288.9074;Inherit;False;Property;_DiffuseColor;Diffuse Color;1;0;Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;625;-1195.632,147.6212;Inherit;True;Property;_SpecularMap;Specular  Map;43;0;Create;True;0;0;0;False;0;False;19;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;380;-1174.927,338.3215;Inherit;False;Property;_SpecularMultiplier;Specular Strength;48;0;Create;False;0;0;0;False;0;False;1;0.5;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;22;-5163.459,1170.561;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;573;-759.7318,-401.0714;Inherit;False;1073.37;1585.308;;18;378;108;572;569;263;595;482;571;596;265;389;177;539;385;180;384;624;627;Specular Highlights;1,0.7932334,0.514151,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;24;-5293.459,1333.562;Inherit;False;Property;_AlphaPower;Alpha Power;7;0;Create;True;0;0;0;False;0;False;1;0.5;0.01;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;177;-709.0319,429.8401;Inherit;True;Property;_FlowMap;Flow Map;42;0;Create;True;0;0;0;False;0;False;19;None;None;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;482;-691.7015,192.9869;Inherit;False;Property;_SpecularMix;Specular Mix;50;0;Create;True;0;0;0;False;0;False;1;0.5;0.5;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;596;-691.4732,362.8531;Inherit;False;Property;_SpecularPowerScale;Specular Smoothness;49;0;Create;False;0;0;0;False;0;False;2;2;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;378;-627.2301,-49.07933;Inherit;False;Property;_SpecularTint;Specular Tint;47;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;597;1078.876,1072.732;Half;False;True;-1;2;;0;0;CustomLighting;Reallusion/Amplify/RL_HairShader_Coverage_3D;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Off;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;1;True;True;0;True;Opaque;;AlphaTest;All;18;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;5;-1;-1;-1;0;True;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;624;42;572;0
WireConnection;624;161;571;0
WireConnection;624;178;108;0
WireConnection;624;84;569;0
WireConnection;624;131;378;0
WireConnection;624;7;595;0
WireConnection;624;172;482;0
WireConnection;624;132;627;0
WireConnection;624;245;596;0
WireConnection;624;108;177;0
WireConnection;624;112;180;0
WireConnection;624;71;384;0
WireConnection;624;75;385;0
WireConnection;624;80;389;0
WireConnection;624;282;539;0
WireConnection;624;207;265;0
WireConnection;624;208;263;0
WireConnection;574;0;624;0
...
ASEEND*/
//CHKSM=FC1D72FB0D6815D11DBE8477F32279596B906C8D