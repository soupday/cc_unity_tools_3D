...
Shader "Reallusion/Amplify/RL_HairShader_2nd_Pass_Variants_3D"
{
	...
	SubShader
	{
		...
		#pragma surface surf StandardCustomLighting keepalpha  alpha:blend
		struct Input
		{
			float2 uv_texcoord;
			half3 worldNormal;
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			half4 break109_g878 = tex2D( _FlowMap, uv_FlowMap );
			half lerpResult123_g878 = lerp( break109_g878.g , ( 1.0 - break109_g878.g ) , _FlowMapFlipGreen);
			half3 appendResult98_g878 = (half3(break109_g878.r , lerpResult123_g878 , break109_g878.b));
			half3 flowTangent107_g878 = (WorldNormalVector( i , ( ( appendResult98_g878 * float3( 2,2,2 ) ) - float3( 1,1,1 ) ) ));
			float2 uv_NormalMap = i.uv_texcoord * _NormalMap_ST.xy + _NormalMap_ST.zw;
			half3 normal282 = UnpackScaleNormal( tex2D( _NormalMap, uv_NormalMap ), _NormalStrength );
			half3 worldNormal86_g878 = normalize( (WorldNormalVector( i , normal282 )) );
			float2 uv_IDMap = i.uv_texcoord * _IDMap_ST.xy + _IDMap_ST.zw;
			half idMap383 = tex2D( _IDMap, uv_IDMap ).r;
			half lerpResult81_g878 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
			half3 normalizeResult10_g879 = normalize( ( flowTangent107_g878 + ( worldNormal86_g878 * lerpResult81_g878 ) ) );
			half3 shiftedTangent119_g878 = normalizeResult10_g879;
			float3 ase_worldPos = i.worldPos;
			half3 ase_worldViewDir = Unity_SafeNormalize( UnityWorldSpaceViewDir( ase_worldPos ) );
			half3 viewDIr52_g880 = ase_worldViewDir;
			#if defined(LIGHTMAP_ON) && UNITY_VERSION < 560 //aseld
			half3 ase_worldlightDir = 0;
			#else //aseld
			half3 ase_worldlightDir = normalize( UnityWorldSpaceLightDir( ase_worldPos ) );
			#endif //aseld
			half3 worldLight272_g878 = ase_worldlightDir;
			half3 lightDIr80_g880 = worldLight272_g878;
			half3 normalizeResult14_g881 = normalize( ( viewDIr52_g880 + lightDIr80_g880 ) );
			half dotResult16_g881 = dot( shiftedTangent119_g878 , normalizeResult14_g881 );
			half smoothstepResult22_g881 = smoothstep( -1.0 , 0.0 , dotResult16_g881);
			...
			half temp_output_233_0_g878 = max( ( 1.0 - smoothness601 ) , 0.001 );
			half specularPower237_g878 = ( max( ( ( 2.0 / ( temp_output_233_0_g878 * temp_output_233_0_g878 ) ) - 2.0 ) , 0.001 ) * _SpecularPower );
			half dotResult266_g878 = dot( normalize( (WorldNormalVector( i , normal282 )) ) , worldLight272_g878 );
			half translucencyWrap283_g878 = _Translucency;
			half lambertMask290_g878 = saturate( ( ( dotResult266_g878 * ( 1.0 - translucencyWrap283_g878 ) ) + translucencyWrap283_g878 ) );
			half temp_output_84_0_g880 = lambertMask290_g878;
			half lambertMask85_g880 = temp_output_84_0_g880;
			half4 temp_output_13_0_g880 = ( ( smoothstepResult22_g881 * pow( saturate( ( 1.0 - ( dotResult16_g881 * dotResult16_g881 ) ) ) , specularPower237_g878 ) ) * _SpecularMultiplier * lambertMask85_g880 * _SpecularTint );
			...
			half4 temp_output_42_0_g878 = baseColor331;
			half4 temp_output_32_0_g880 = temp_output_42_0_g878;
			half4 lerpResult36_g880 = lerp( temp_output_13_0_g880 , ( temp_output_13_0_g880 * temp_output_32_0_g880 ) , _SpecularMix);
			half3 temp_output_24_0_g880 = worldNormal86_g878;
			half dotResult82_g880 = dot( temp_output_24_0_g880 , lightDIr80_g880 );
			half temp_output_40_0_g880 = translucencyWrap283_g878;
			half dotResult54_g880 = dot( temp_output_24_0_g880 , viewDIr52_g880 );
			half dotResult57_g880 = dot( viewDIr52_g880 , lightDIr80_g880 );
			#if defined(LIGHTMAP_ON) && ( UNITY_VERSION < 560 || ( defined(LIGHTMAP_SHADOW_MIXING) && !defined(SHADOWS_SHADOWMASK) && defined(SHADOWS_SCREEN) ) )//aselc
			half4 ase_lightColor = 0;
			#else //aselc
			half4 ase_lightColor = _LightColor0;
			#endif //aselc
			half4 temp_output_296_0_g878 = ( ase_lightAtten * ( ( lerpResult36_g880 + ( ( saturate( ( ( dotResult82_g880 * ( 1.0 - temp_output_40_0_g880 ) ) + temp_output_40_0_g880 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g880 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g880 ) , 0.0 ) ) , _RimPower ) * _RimTransmissionIntensity * temp_output_84_0_g880 ) ) * temp_output_32_0_g880 ) ) * ase_lightColor ) );
			UnityGI gi53_g878 = gi;
			float3 diffNorm53_g878 = WorldNormalVector( i , worldNormal86_g878 );
			gi53_g878 = UnityGI_Base( data, 1, diffNorm53_g878 );
			half3 indirectDiffuse53_g878 = gi53_g878.indirect.diffuse + diffNorm53_g878 * 0.0001;
			half ambientOcclusion570 = ( 1.0 - ( _AOStrength * ( 1.0 - tex2DNode115.g ) ) );
			half temp_output_161_0_g878 = ambientOcclusion570;
			half temp_output_178_0_g878 = _AOOccludeAll;
			half lerpResult180_g878 = lerp( temp_output_161_0_g878 , 1.0 , temp_output_178_0_g878);
			#ifdef UNITY_PASS_FORWARDBASE
				half4 staticSwitch250_g878 = ( temp_output_296_0_g878 + ( half4( indirectDiffuse53_g878 , 0.0 ) * temp_output_42_0_g878 * lerpResult180_g878 ) );
			#else
				half4 staticSwitch250_g878 = temp_output_296_0_g878;
			#endif
			half lerpResult183_g878 = lerp( 1.0 , temp_output_161_0_g878 , temp_output_178_0_g878);
			float2 uv_EmissionMap = i.uv_texcoord * _EmissionMap_ST.xy + _EmissionMap_ST.zw;
			clip( alpha518 - 0.05882353);
			c.rgb = ( ( staticSwitch250_g878 * lerpResult183_g878 ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
/*ASEBEGIN
Version=18935
1938;7;1920;1011;933.5148;112.8076;1;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;573;-759.7318,-401.0714;Inherit;False;1094.991;1595.513;;18;609;263;180;177;265;384;539;385;389;482;378;380;569;602;571;108;572;620;Specular Highlights;1,0.7932334,0.514151,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;263;-673.4631,1077.508;Inherit;False;Property;_RimPower;Rim Hardness;41;0;Create;False;0;0;0;False;0;False;4;2.5;1;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;539;-677.5486,927.3325;Inherit;False;Property;_Translucency;Translucency;49;0;Create;True;0;0;0;False;0;False;0;0.15;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;611;1122.054,1161.637;Half;False;True;-1;2;ASEMaterialInspector;0;0;CustomLighting;Reallusion/Amplify/RL_HairShader_2nd_Pass_Variants_3D;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;False;False;False;False;False;Off;2;False;-1;1;False;-1;False;0;False;-1;0;False;-1;False;1;Custom;0;True;False;0;True;Transparent;AlphaZLess;Transparent;All;18;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;2;5;False;-1;10;False;-1;0;5;False;-1;10;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;1;alpha:blend;0;False;0.1;False;-1;0;False;-1;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;620;42;572;0
WireConnection;620;161;571;0
WireConnection;620;178;108;0
WireConnection;620;84;569;0
WireConnection;620;131;378;0
WireConnection;620;7;602;0
WireConnection;620;172;482;0
WireConnection;620;132;380;0
WireConnection;620;245;609;0
WireConnection;620;108;177;0
WireConnection;620;112;180;0
WireConnection;620;71;384;0
WireConnection;620;75;385;0
WireConnection;620;80;389;0
WireConnection;620;282;539;0
WireConnection;620;207;265;0
WireConnection;620;208;263;0
WireConnection;574;0;620;0
...
ASEEND*/
//CHKSM=40098AD9A690A3C2D33FF3F41E25F95DD1809B59