...
Shader "Reallusion/Amplify/RL_HairShader_2nd_Pass_Variants_3D"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			half4 break109_g862 = tex2D( _FlowMap, uv_FlowMap );
			half lerpResult123_g862 = lerp( break109_g862.g , ( 1.0 - break109_g862.g ) , _FlowMapFlipGreen);
			half3 appendResult98_g862 = (half3(break109_g862.r , lerpResult123_g862 , break109_g862.b));
			half3 flowTangent107_g862 = (WorldNormalVector( i , ( ( appendResult98_g862 * float3( 2,2,2 ) ) - float3( 1,1,1 ) ) ));
			float2 uv_NormalMap = i.uv_texcoord * _NormalMap_ST.xy + _NormalMap_ST.zw;
			half3 normal282 = UnpackScaleNormal( tex2D( _NormalMap, uv_NormalMap ), _NormalStrength );
			half3 worldNormal86_g862 = normalize( (WorldNormalVector( i , normal282 )) );
			float2 uv_IDMap = i.uv_texcoord * _IDMap_ST.xy + _IDMap_ST.zw;
			half idMap383 = tex2D( _IDMap, uv_IDMap ).r;
			half lerpResult81_g862 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
			half3 normalizeResult10_g863 = normalize( ( flowTangent107_g862 + ( worldNormal86_g862 * lerpResult81_g862 ) ) );
			half3 shiftedTangent119_g862 = normalizeResult10_g863;
			float3 ase_worldPos = i.worldPos;
			half3 ase_worldViewDir = Unity_SafeNormalize( UnityWorldSpaceViewDir( ase_worldPos ) );
			half3 viewDIr52_g864 = ase_worldViewDir;
			#if defined(LIGHTMAP_ON) && UNITY_VERSION < 560 //aseld
			half3 ase_worldlightDir = 0;
			#else //aseld
			half3 ase_worldlightDir = Unity_SafeNormalize( UnityWorldSpaceLightDir( ase_worldPos ) );
			#endif //aseld
			half3 lightDir55_g864 = ase_worldlightDir;
			half3 normalizeResult14_g865 = normalize( ( viewDIr52_g864 + lightDir55_g864 ) );
			half dotResult16_g865 = dot( shiftedTangent119_g862 , normalizeResult14_g865 );
			half smoothstepResult22_g865 = smoothstep( -1.0 , 0.0 , dotResult16_g865);
			...
			half temp_output_233_0_g862 = max( ( 1.0 - smoothness601 ) , 0.001 );
			half specularPower237_g862 = ( max( ( ( 2.0 / ( temp_output_233_0_g862 * temp_output_233_0_g862 ) ) - 2.0 ) , 0.001 ) * _SpecularPower );
			half3 temp_output_24_0_g864 = worldNormal86_g862;
			half dotResult15_g864 = dot( lightDir55_g864 , temp_output_24_0_g864 );
			half temp_output_40_0_g864 = _Translucency;
			half temp_output_6_0_g864 = saturate( ( ( dotResult15_g864 * ( 1.0 - temp_output_40_0_g864 ) ) + temp_output_40_0_g864 ) );
			half wrappedLambert74_g864 = temp_output_6_0_g864;
			half4 temp_output_13_0_g864 = ( ( smoothstepResult22_g865 * pow( saturate( ( 1.0 - ( dotResult16_g865 * dotResult16_g865 ) ) ) , specularPower237_g862 ) ) * _SpecularMultiplier * wrappedLambert74_g864 * _SpecularTint );
			...
			half4 temp_output_42_0_g862 = baseColor331;
			half4 temp_output_32_0_g864 = temp_output_42_0_g862;
			half4 lerpResult36_g864 = lerp( temp_output_13_0_g864 , ( temp_output_13_0_g864 * temp_output_32_0_g864 ) , _SpecularMix);
			half dotResult54_g864 = dot( temp_output_24_0_g864 , viewDIr52_g864 );
			half dotResult57_g864 = dot( viewDIr52_g864 , lightDir55_g864 );
			#if defined(LIGHTMAP_ON) && ( UNITY_VERSION < 560 || ( defined(LIGHTMAP_SHADOW_MIXING) && !defined(SHADOWS_SHADOWMASK) && defined(SHADOWS_SCREEN) ) )//aselc
			half4 ase_lightColor = 0;
			#else //aselc
			half4 ase_lightColor = _LightColor0;
			#endif //aselc
			half4 temp_output_262_0_g862 = ( ase_lightAtten * ( ( lerpResult36_g864 + ( ( temp_output_6_0_g864 + ( pow( ( max( ( 1.0 - abs( dotResult54_g864 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g864 ) , 0.0 ) ) , _RimPower ) * _RimTransmissionIntensity * wrappedLambert74_g864 ) ) * temp_output_32_0_g864 ) ) * ase_lightColor ) );
			UnityGI gi53_g862 = gi;
			float3 diffNorm53_g862 = WorldNormalVector( i , worldNormal86_g862 );
			gi53_g862 = UnityGI_Base( data, 1, diffNorm53_g862 );
			half3 indirectDiffuse53_g862 = gi53_g862.indirect.diffuse + diffNorm53_g862 * 0.0001;
			half ambientOcclusion570 = ( 1.0 - ( _AOStrength * ( 1.0 - tex2DNode115.g ) ) );
			half temp_output_161_0_g862 = ambientOcclusion570;
			half temp_output_178_0_g862 = _AOOccludeAll;
			half lerpResult180_g862 = lerp( temp_output_161_0_g862 , 1.0 , temp_output_178_0_g862);
			#ifdef UNITY_PASS_FORWARDBASE
				half4 staticSwitch250_g862 = ( temp_output_262_0_g862 + ( half4( indirectDiffuse53_g862 , 0.0 ) * temp_output_42_0_g862 * lerpResult180_g862 ) );
			#else
				half4 staticSwitch250_g862 = temp_output_262_0_g862;
			#endif
			half lerpResult183_g862 = lerp( 1.0 , temp_output_161_0_g862 , temp_output_178_0_g862);
			float2 uv_EmissionMap = i.uv_texcoord * _EmissionMap_ST.xy + _EmissionMap_ST.zw;
			clip( alpha518 - 0.05882353);
			c.rgb = ( ( staticSwitch250_g862 * lerpResult183_g862 ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
/*ASEBEGIN
Version=18935
1913;20;1920;969;406.9886;-947.8456;1;True;False
...
ASEEND*/
//CHKSM=A0CC9B845468C4913C1DF483FCFD6D684977D0FA