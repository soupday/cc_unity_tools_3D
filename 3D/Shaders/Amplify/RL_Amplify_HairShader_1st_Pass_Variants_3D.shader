...
Shader "Reallusion/Amplify/RL_HairShader_1st_Pass_Variants_3D"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			half4 break109_g800 = tex2D( _FlowMap, uv_FlowMap );
			half lerpResult123_g800 = lerp( break109_g800.g , ( 1.0 - break109_g800.g ) , _FlowMapFlipGreen);
			half3 appendResult98_g800 = (half3(break109_g800.r , lerpResult123_g800 , break109_g800.b));
			half3 flowTangent107_g800 = (WorldNormalVector( i , ( ( appendResult98_g800 * float3( 2,2,2 ) ) - float3( 1,1,1 ) ) ));
			...
			#endif //aseld
			half3 worldLight272_g800 = ase_worldlightDir;
			half dotResult266_g800 = dot( normalize( (WorldNormalVector( i , normal282 )) ) , worldLight272_g800 );
			half3 lerpResult269_g800 = lerp( normalize( (WorldNormalVector( i , normal282 )) ) , -normalize( (WorldNormalVector( i , normal282 )) ) , step( dotResult266_g800 , 0.0 ));
			half3 worldNormal86_g800 = lerpResult269_g800;
			float2 uv_IDMap = i.uv_texcoord * _IDMap_ST.xy + _IDMap_ST.zw;
			half idMap383 = tex2D( _IDMap, uv_IDMap ).r;
			half lerpResult81_g800 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
			half3 normalizeResult10_g801 = normalize( ( flowTangent107_g800 + ( worldNormal86_g800 * lerpResult81_g800 ) ) );
			half3 shiftedTangent119_g800 = normalizeResult10_g801;
			half3 ase_worldViewDir = Unity_SafeNormalize( UnityWorldSpaceViewDir( ase_worldPos ) );
			half3 viewDIr52_g802 = ase_worldViewDir;
			half3 lightDIr80_g802 = worldLight272_g800;
			half3 normalizeResult14_g803 = normalize( ( viewDIr52_g802 + lightDIr80_g802 ) );
			half dotResult16_g803 = dot( shiftedTangent119_g800 , normalizeResult14_g803 );
			half smoothstepResult22_g803 = smoothstep( -1.0 , 0.0 , dotResult16_g803);
			...
			half temp_output_233_0_g800 = max( ( 1.0 - smoothness587 ) , 0.001 );
			half specularPower237_g800 = ( max( ( ( 2.0 / ( temp_output_233_0_g800 * temp_output_233_0_g800 ) ) - 2.0 ) , 0.001 ) * _SpecularPowerScale );
			half translucencyWrap283_g800 = _Translucency;
			half lambertMask290_g800 = saturate( ( ( dotResult266_g800 * ( 1.0 - translucencyWrap283_g800 ) ) + translucencyWrap283_g800 ) );
			half temp_output_84_0_g802 = lambertMask290_g800;
			half lambertMask85_g802 = temp_output_84_0_g802;
			half4 temp_output_13_0_g802 = ( ( smoothstepResult22_g803 * pow( saturate( ( 1.0 - ( dotResult16_g803 * dotResult16_g803 ) ) ) , specularPower237_g800 ) ) * _SpecularMultiplier * lambertMask85_g802 * _SpecularTint );
			...
			half4 temp_output_42_0_g800 = baseColor331;
			half4 temp_output_32_0_g802 = temp_output_42_0_g800;
			half4 lerpResult36_g802 = lerp( temp_output_13_0_g802 , ( temp_output_13_0_g802 * temp_output_32_0_g802 ) , _SpecularMix);
			half3 temp_output_24_0_g802 = worldNormal86_g800;
			half dotResult82_g802 = dot( temp_output_24_0_g802 , lightDIr80_g802 );
			half temp_output_40_0_g802 = translucencyWrap283_g800;
			half dotResult54_g802 = dot( temp_output_24_0_g802 , viewDIr52_g802 );
			half dotResult57_g802 = dot( viewDIr52_g802 , lightDIr80_g802 );
			#if defined(LIGHTMAP_ON) && ( UNITY_VERSION < 560 || ( defined(LIGHTMAP_SHADOW_MIXING) && !defined(SHADOWS_SHADOWMASK) && defined(SHADOWS_SCREEN) ) )//aselc
			half4 ase_lightColor = 0;
			#else //aselc
			half4 ase_lightColor = _LightColor0;
			#endif //aselc
			half4 temp_output_296_0_g800 = ( ase_lightAtten * ( ( lerpResult36_g802 + ( ( saturate( ( ( dotResult82_g802 * ( 1.0 - temp_output_40_0_g802 ) ) + temp_output_40_0_g802 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g802 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g802 ) , 0.0 ) ) , _RimPower ) * _RimTransmissionIntensity * temp_output_84_0_g802 ) ) * temp_output_32_0_g802 ) ) * ase_lightColor ) );
			UnityGI gi53_g800 = gi;
			float3 diffNorm53_g800 = WorldNormalVector( i , worldNormal86_g800 );
			gi53_g800 = UnityGI_Base( data, 1, diffNorm53_g800 );
			half3 indirectDiffuse53_g800 = gi53_g800.indirect.diffuse + diffNorm53_g800 * 0.0001;
			half ambientOcclusion570 = ( 1.0 - ( _AOStrength * ( 1.0 - tex2DNode115.g ) ) );
			half temp_output_161_0_g800 = ambientOcclusion570;
			half temp_output_178_0_g800 = _AOOccludeAll;
			half lerpResult180_g800 = lerp( temp_output_161_0_g800 , 1.0 , temp_output_178_0_g800);
			#ifdef UNITY_PASS_FORWARDBASE
				half4 staticSwitch250_g800 = ( temp_output_296_0_g800 + ( half4( indirectDiffuse53_g800 , 0.0 ) * temp_output_42_0_g800 * lerpResult180_g800 ) );
			#else
				half4 staticSwitch250_g800 = temp_output_296_0_g800;
			#endif
			half lerpResult183_g800 = lerp( 1.0 , temp_output_161_0_g800 , temp_output_178_0_g800);
			float2 uv_EmissionMap = i.uv_texcoord * _EmissionMap_ST.xy + _EmissionMap_ST.zw;
			clip( alpha518 - _AlphaClip);
			c.rgb = ( ( staticSwitch250_g800 * lerpResult183_g800 ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
/*ASEBEGIN
Version=18935
1938;7;1920;1011;973.3139;31.5974;1.412366;True;False
...
WireConnection;599;42;572;0
WireConnection;599;161;571;0
WireConnection;599;178;108;0
WireConnection;599;84;569;0
WireConnection;599;131;378;0
WireConnection;599;7;588;0
WireConnection;599;172;482;0
WireConnection;599;132;380;0
WireConnection;599;245;591;0
WireConnection;599;108;177;0
WireConnection;599;112;180;0
WireConnection;599;71;384;0
WireConnection;599;75;385;0
WireConnection;599;80;389;0
WireConnection;599;282;539;0
WireConnection;599;207;265;0
WireConnection;599;208;263;0
WireConnection;574;0;599;0
...
ASEEND*/
//CHKSM=9B432472212935C5F75E29C5E018EE5416DBA357