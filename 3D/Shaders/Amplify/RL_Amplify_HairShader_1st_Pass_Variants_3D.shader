...
Shader "Reallusion/Amplify/RL_HairShader_1st_Pass_Variants_3D"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			half4 break109_g808 = tex2D( _FlowMap, uv_FlowMap );
			half lerpResult123_g808 = lerp( break109_g808.g , ( 1.0 - break109_g808.g ) , _FlowMapFlipGreen);
			half3 appendResult98_g808 = (half3(break109_g808.r , lerpResult123_g808 , break109_g808.b));
			half3 flowTangent107_g808 = (WorldNormalVector( i , ( ( appendResult98_g808 * float3( 2,2,2 ) ) - float3( 1,1,1 ) ) ));
			...
			#endif //aseld
			half3 worldLight272_g808 = ase_worldlightDir;
			half dotResult266_g808 = dot( normalize( (WorldNormalVector( i , normal282 )) ) , worldLight272_g808 );
			half3 lerpResult269_g808 = lerp( normalize( (WorldNormalVector( i , normal282 )) ) , -normalize( (WorldNormalVector( i , normal282 )) ) , step( dotResult266_g808 , 0.0 ));
			half3 worldNormal86_g808 = lerpResult269_g808;
			float2 uv_IDMap = i.uv_texcoord * _IDMap_ST.xy + _IDMap_ST.zw;
			half idMap383 = tex2D( _IDMap, uv_IDMap ).r;
			half lerpResult81_g808 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
			half3 normalizeResult10_g809 = normalize( ( flowTangent107_g808 + ( worldNormal86_g808 * lerpResult81_g808 ) ) );
			half3 shiftedTangent119_g808 = normalizeResult10_g809;
			half3 ase_worldViewDir = Unity_SafeNormalize( UnityWorldSpaceViewDir( ase_worldPos ) );
			half3 viewDIr52_g810 = ase_worldViewDir;
			half3 lightDIr80_g810 = worldLight272_g808;
			half3 normalizeResult14_g811 = normalize( ( viewDIr52_g810 + lightDIr80_g810 ) );
			half dotResult16_g811 = dot( shiftedTangent119_g808 , normalizeResult14_g811 );
			half smoothstepResult22_g811 = smoothstep( -1.0 , 0.0 , dotResult16_g811);
			...
			half temp_output_233_0_g808 = max( ( 1.0 - smoothness587 ) , 0.001 );
			half specularPower237_g808 = ( max( ( ( 2.0 / ( temp_output_233_0_g808 * temp_output_233_0_g808 ) ) - 2.0 ) , 0.001 ) * _SpecularPowerScale );
			float2 uv_SpecularMap = i.uv_texcoord * _SpecularMap_ST.xy + _SpecularMap_ST.zw;
			half translucencyWrap283_g808 = _Translucency;
			half lambertMask290_g808 = saturate( ( ( dotResult266_g808 * ( 1.0 - translucencyWrap283_g808 ) ) + translucencyWrap283_g808 ) );
			half temp_output_84_0_g810 = lambertMask290_g808;
			half lambertMask85_g810 = temp_output_84_0_g810;
			half4 temp_output_13_0_g810 = ( ( smoothstepResult22_g811 * pow( saturate( ( 1.0 - ( dotResult16_g811 * dotResult16_g811 ) ) ) , specularPower237_g808 ) ) * ( tex2D( _SpecularMap, uv_SpecularMap ).g * _SpecularMultiplier ) * lambertMask85_g810 * _SpecularTint );
			float2 uv_BlendMap = i.uv_texcoord * _BlendMap_ST.xy + _BlendMap_ST.zw;
			half4 diffuseMap517 = tex2DNode19;
			half4 color10_g773 = IsGammaSpace() ? half4(1,1,1,0) : half4(1,1,1,0);
			half4 lerpResult18_g773 = lerp( color10_g773 , diffuseMap517 , _BaseColorStrength);
			float2 uv_RootMap = i.uv_texcoord * _RootMap_ST.xy + _RootMap_ST.zw;
			half root58 = tex2D( _RootMap, uv_RootMap ).r;
			half temp_output_27_0_g773 = root58;
			half lerpResult23_g773 = lerp( temp_output_27_0_g773 , ( 1.0 - temp_output_27_0_g773 ) , _InvertRootMap);
			half4 lerpResult3_g773 = lerp( _RootColor , _EndColor , lerpResult23_g773);
			half4 lerpResult6_g773 = lerp( lerpResult18_g773 , lerpResult3_g773 , ( _GlobalStrength * ( ( ( 1.0 - temp_output_27_0_g773 ) * _RootColorStrength ) + ( temp_output_27_0_g773 * _EndColorStrength ) ) ));
			...
			half lerpResult16_g778 = lerp( ( 1.0 - temp_output_24_0_g778 ) , temp_output_24_0_g778 , _HighlightAOverlapInvert);
			half4 lerpResult18_g778 = lerp( lerpResult6_g773 , _HighlightAColor , saturate( ( localThreePointDistribution8_g778 * ( 1.0 - ( _HighlightAOverlapEnd * ( 1.0 - lerpResult16_g778 ) ) ) ) ));
			...
			half lerpResult16_g779 = lerp( ( 1.0 - temp_output_24_0_g779 ) , temp_output_24_0_g779 , _HighlightBOverlapInvert);
			half4 lerpResult18_g779 = lerp( lerpResult18_g778 , _HighlightBColor , saturate( ( localThreePointDistribution8_g779 * ( 1.0 - ( _HighlightBOverlapEnd * ( 1.0 - lerpResult16_g779 ) ) ) ) ));
			...
			half4 temp_output_42_0_g808 = baseColor331;
			half4 temp_output_32_0_g810 = temp_output_42_0_g808;
			half4 lerpResult36_g810 = lerp( temp_output_13_0_g810 , ( temp_output_13_0_g810 * temp_output_32_0_g810 ) , _SpecularMix);
			half3 temp_output_24_0_g810 = worldNormal86_g808;
			half dotResult82_g810 = dot( lightDIr80_g810 , temp_output_24_0_g810 );
			half temp_output_40_0_g810 = translucencyWrap283_g808;
			half dotResult54_g810 = dot( temp_output_24_0_g810 , viewDIr52_g810 );
			half dotResult57_g810 = dot( viewDIr52_g810 , lightDIr80_g810 );
			#if defined(LIGHTMAP_ON) && ( UNITY_VERSION < 560 || ( defined(LIGHTMAP_SHADOW_MIXING) && !defined(SHADOWS_SHADOWMASK) && defined(SHADOWS_SCREEN) ) )//aselc
			half4 ase_lightColor = 0;
			#else //aselc
			half4 ase_lightColor = _LightColor0;
			#endif //aselc
			half4 temp_output_297_0_g808 = ( ase_lightAtten * ( ( lerpResult36_g810 + ( ( saturate( ( ( dotResult82_g810 * ( 1.0 - temp_output_40_0_g810 ) ) + temp_output_40_0_g810 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g810 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g810 ) , 0.0 ) ) , _RimPower ) * _RimTransmissionIntensity * temp_output_84_0_g810 ) ) * temp_output_32_0_g810 ) ) * ase_lightColor ) );
			UnityGI gi53_g808 = gi;
			float3 diffNorm53_g808 = WorldNormalVector( i , worldNormal86_g808 );
			gi53_g808 = UnityGI_Base( data, 1, diffNorm53_g808 );
			half3 indirectDiffuse53_g808 = gi53_g808.indirect.diffuse + diffNorm53_g808 * 0.0001;
			half ambientOcclusion570 = ( 1.0 - ( _AOStrength * ( 1.0 - tex2DNode115.g ) ) );
			half temp_output_161_0_g808 = ambientOcclusion570;
			half temp_output_178_0_g808 = _AOOccludeAll;
			half lerpResult180_g808 = lerp( temp_output_161_0_g808 , 1.0 , temp_output_178_0_g808);
			#ifdef UNITY_PASS_FORWARDBASE
				half4 staticSwitch250_g808 = ( temp_output_297_0_g808 + ( half4( indirectDiffuse53_g808 , 0.0 ) * temp_output_42_0_g808 * lerpResult180_g808 ) );
			#else
				half4 staticSwitch250_g808 = temp_output_297_0_g808;
			#endif
			half lerpResult183_g808 = lerp( 1.0 , temp_output_161_0_g808 , temp_output_178_0_g808);
			float2 uv_EmissionMap = i.uv_texcoord * _EmissionMap_ST.xy + _EmissionMap_ST.zw;
			clip( alpha518 - _AlphaClip);
			c.rgb = ( ( staticSwitch250_g808 * lerpResult183_g808 ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
/*ASEBEGIN
Version=18935
1920;0;1920;1029;2468.703;445.1646;1.3;True;False
...
Node;AmplifyShaderEditor.FunctionNode;523;-5087.463,-880.7275;Inherit;False;RL_Amplify_Function_Hair_RootBlend;-1;;773;3304ef6ee2139bd4cab5d899498bc3dd;0;9;26;COLOR;0,0,0,0;False;37;FLOAT;1;False;27;FLOAT;0;False;31;FLOAT;1;False;35;COLOR;0.3294118,0.1411765,0.05098039,0;False;36;COLOR;0.6039216,0.454902,0.2862745,0;False;32;FLOAT;1;False;33;FLOAT;1;False;34;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;123;-2213.958,1968.688;Inherit;False;Property;_SmoothnessPower;Smoothness Power;13;0;Create;True;0;0;0;False;0;False;1.25;1;0.5;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;125;-1724.759,1811.414;Inherit;False;Property;_SmoothnessMax;Smoothness Max;15;0;Create;True;0;0;0;False;0;False;1;0.88;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;605;-1530.903,-295.6645;Inherit;False;Property;_DiffuseColor;Diffuse Color;1;0;Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;380;-1204.028,337.0532;Inherit;False;Property;_SpecularMultiplier;Specular Strength;47;0;Create;False;0;0;0;False;0;False;1;0.5;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;602;-1211.443,146.042;Inherit;True;Property;_SpecularMap;Specular  Map;42;0;Create;True;0;0;0;False;0;False;19;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CommentaryNode;573;-759.7318,-401.0714;Inherit;False;1124.398;1585.429;;18;384;571;378;265;180;263;389;482;572;177;385;588;108;569;539;591;601;604;Specular Highlights;1,0.7932334,0.514151,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;263;-675.4739,1076.239;Inherit;False;Property;_RimPower;Rim Hardness;44;0;Create;False;0;0;0;False;0;False;4;2.5;1;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;539;-678.5594,926.0629;Inherit;False;Property;_Translucency;Translucency;52;0;Create;True;0;0;0;False;0;False;0;0.15;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;177;-708.1495,432.6585;Inherit;True;Property;_FlowMap;Flow Map;41;0;Create;True;0;0;0;False;0;False;19;None;None;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;591;-688.9429,353.1747;Inherit;False;Property;_SpecularPowerScale;Specular Smoothness;48;0;Create;False;0;0;0;False;0;False;2;2;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;574;642.9501,1161.29;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;162;329.1628,1539.112;Inherit;False;Property;_AlphaClip;Alpha Clip;9;0;Create;False;0;0;0;True;0;False;0.15;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;593;1156.928,1176.715;Half;False;True;-1;2;;0;0;CustomLighting;Reallusion/Amplify/RL_HairShader_1st_Pass_Variants_3D;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Off;1;False;-1;3;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;1;True;True;0;True;Opaque;;AlphaTest;All;18;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;3;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;162;0;0;0;False;0.1;False;-1;0;False;-1;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;601;42;572;0
WireConnection;601;161;571;0
WireConnection;601;178;108;0
WireConnection;601;84;569;0
WireConnection;601;131;378;0
WireConnection;601;7;588;0
WireConnection;601;172;482;0
WireConnection;601;132;604;0
WireConnection;601;245;591;0
WireConnection;601;108;177;0
WireConnection;601;112;180;0
WireConnection;601;71;384;0
WireConnection;601;75;385;0
WireConnection;601;80;389;0
WireConnection;601;282;539;0
WireConnection;601;207;265;0
WireConnection;601;208;263;0
WireConnection;135;0;133;0
WireConnection;135;1;134;0
WireConnection;518;0;23;0
WireConnection;574;0;601;0
...
ASEEND*/
//CHKSM=5E1A664EC0AD571957B38C987C1422A8E08FF78C