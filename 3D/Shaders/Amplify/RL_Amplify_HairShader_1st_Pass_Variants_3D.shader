...
Shader "Reallusion/Amplify/RL_HairShader_1st_Pass_Variants_3D"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			half4 break109_g796 = tex2D( _FlowMap, uv_FlowMap );
			half lerpResult123_g796 = lerp( break109_g796.g , ( 1.0 - break109_g796.g ) , _FlowMapFlipGreen);
			half3 appendResult98_g796 = (half3(break109_g796.r , lerpResult123_g796 , break109_g796.b));
			half3 flowTangent107_g796 = (WorldNormalVector( i , ( ( appendResult98_g796 * float3( 2,2,2 ) ) - float3( 1,1,1 ) ) ));
			float2 uv_NormalMap = i.uv_texcoord * _NormalMap_ST.xy + _NormalMap_ST.zw;
			half3 normal282 = UnpackScaleNormal( tex2D( _NormalMap, uv_NormalMap ), _NormalStrength );
			half3 worldNormal86_g796 = normalize( (WorldNormalVector( i , normal282 )) );
			float2 uv_IDMap = i.uv_texcoord * _IDMap_ST.xy + _IDMap_ST.zw;
			half idMap383 = tex2D( _IDMap, uv_IDMap ).r;
			half lerpResult81_g796 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
			half3 normalizeResult10_g797 = normalize( ( flowTangent107_g796 + ( worldNormal86_g796 * lerpResult81_g796 ) ) );
			half3 shiftedTangent119_g796 = normalizeResult10_g797;
			float3 ase_worldPos = i.worldPos;
			half3 ase_worldViewDir = Unity_SafeNormalize( UnityWorldSpaceViewDir( ase_worldPos ) );
			half3 viewDIr52_g798 = ase_worldViewDir;
			#if defined(LIGHTMAP_ON) && UNITY_VERSION < 560 //aseld
			half3 ase_worldlightDir = 0;
			#else //aseld
			half3 ase_worldlightDir = Unity_SafeNormalize( UnityWorldSpaceLightDir( ase_worldPos ) );
			#endif //aseld
			half3 lightDir55_g798 = ase_worldlightDir;
			half3 normalizeResult14_g799 = normalize( ( viewDIr52_g798 + lightDir55_g798 ) );
			half dotResult16_g799 = dot( shiftedTangent119_g796 , normalizeResult14_g799 );
			half smoothstepResult22_g799 = smoothstep( -1.0 , 0.0 , dotResult16_g799);
			...
			half temp_output_233_0_g796 = max( ( 1.0 - smoothness587 ) , 0.001 );
			half specularPower237_g796 = ( max( ( ( 2.0 / ( temp_output_233_0_g796 * temp_output_233_0_g796 ) ) - 2.0 ) , 0.001 ) * _SpecularPowerScale );
			half3 temp_output_24_0_g798 = worldNormal86_g796;
			half dotResult15_g798 = dot( lightDir55_g798 , temp_output_24_0_g798 );
			half temp_output_40_0_g798 = _Translucency;
			half temp_output_6_0_g798 = saturate( ( ( dotResult15_g798 * ( 1.0 - temp_output_40_0_g798 ) ) + temp_output_40_0_g798 ) );
			half wrappedLambert74_g798 = temp_output_6_0_g798;
			half4 temp_output_13_0_g798 = ( ( smoothstepResult22_g799 * pow( saturate( ( 1.0 - ( dotResult16_g799 * dotResult16_g799 ) ) ) , specularPower237_g796 ) ) * _SpecularMultiplier * wrappedLambert74_g798 * _SpecularTint );
			...
			half4 temp_output_42_0_g796 = baseColor331;
			half4 temp_output_32_0_g798 = temp_output_42_0_g796;
			half4 lerpResult36_g798 = lerp( temp_output_13_0_g798 , ( temp_output_13_0_g798 * temp_output_32_0_g798 ) , _SpecularMix);
			half dotResult54_g798 = dot( temp_output_24_0_g798 , viewDIr52_g798 );
			half dotResult57_g798 = dot( viewDIr52_g798 , lightDir55_g798 );
			#if defined(LIGHTMAP_ON) && ( UNITY_VERSION < 560 || ( defined(LIGHTMAP_SHADOW_MIXING) && !defined(SHADOWS_SHADOWMASK) && defined(SHADOWS_SCREEN) ) )//aselc
			half4 ase_lightColor = 0;
			#else //aselc
			half4 ase_lightColor = _LightColor0;
			#endif //aselc
			half4 temp_output_263_0_g796 = ( ase_lightAtten * ( ( lerpResult36_g798 + ( ( temp_output_6_0_g798 + ( pow( ( max( ( 1.0 - abs( dotResult54_g798 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g798 ) , 0.0 ) ) , _RimPower ) * _RimTransmissionIntensity * wrappedLambert74_g798 ) ) * temp_output_32_0_g798 ) ) * ase_lightColor ) );
			UnityGI gi53_g796 = gi;
			float3 diffNorm53_g796 = WorldNormalVector( i , worldNormal86_g796 );
			gi53_g796 = UnityGI_Base( data, 1, diffNorm53_g796 );
			half3 indirectDiffuse53_g796 = gi53_g796.indirect.diffuse + diffNorm53_g796 * 0.0001;
			half ambientOcclusion570 = ( 1.0 - ( _AOStrength * ( 1.0 - tex2DNode115.g ) ) );
			half temp_output_161_0_g796 = ambientOcclusion570;
			half temp_output_178_0_g796 = _AOOccludeAll;
			half lerpResult180_g796 = lerp( temp_output_161_0_g796 , 1.0 , temp_output_178_0_g796);
			#ifdef UNITY_PASS_FORWARDBASE
				half4 staticSwitch250_g796 = ( temp_output_263_0_g796 + ( half4( indirectDiffuse53_g796 , 0.0 ) * temp_output_42_0_g796 * lerpResult180_g796 ) );
			#else
				half4 staticSwitch250_g796 = temp_output_263_0_g796;
			#endif
			half lerpResult183_g796 = lerp( 1.0 , temp_output_161_0_g796 , temp_output_178_0_g796);
			float2 uv_EmissionMap = i.uv_texcoord * _EmissionMap_ST.xy + _EmissionMap_ST.zw;
			clip( alpha518 - _AlphaClip);
			c.rgb = ( ( staticSwitch250_g796 * lerpResult183_g796 ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
/*ASEBEGIN
Version=18935
1920;0;1920;1029;176.2437;-952.1005;1;True;False
...
WireConnection;598;42;572;0
WireConnection;598;161;571;0
WireConnection;598;178;108;0
WireConnection;598;84;569;0
WireConnection;598;131;378;0
WireConnection;598;7;588;0
WireConnection;598;172;482;0
WireConnection;598;132;380;0
WireConnection;598;245;591;0
WireConnection;598;108;177;0
WireConnection;598;112;180;0
WireConnection;598;71;384;0
WireConnection;598;75;385;0
WireConnection;598;80;389;0
WireConnection;598;200;539;0
WireConnection;598;207;265;0
WireConnection;598;208;263;0
WireConnection;574;0;598;0
...
ASEEND*/
//CHKSM=CEBC656C5AED19E9D2264C6A31B5C50B63FDFD70