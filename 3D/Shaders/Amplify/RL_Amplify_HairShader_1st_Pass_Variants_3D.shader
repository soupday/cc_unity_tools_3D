...
Shader "Reallusion/Amplify/RL_HairShader_1st_Pass_Variants_3D"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			half4 lerpResult41_g773 = lerp( float4( 1,1,1,0 ) , float4( 0,0,0,0 ) , 1.0);
			half temp_output_55_0_g773 = 0.0;
			half lerpResult50_g773 = lerp( temp_output_55_0_g773 , ( 1.0 - temp_output_55_0_g773 ) , 1.0);
			half4 lerpResult44_g773 = lerp( float4( 0.3294118,0.1411765,0.05098039,0 ) , float4( 0.6039216,0.454902,0.2862745,0 ) , lerpResult50_g773);
			half lerpResult43_g773 = lerp( 1.0 , 1.0 , lerpResult50_g773);
			half4 lerpResult53_g773 = lerp( lerpResult41_g773 , lerpResult44_g773 , ( lerpResult43_g773 * 1.0 ));
			...
			half lerpResult183_g808 = lerp( 1.0 , temp_output_161_0_g808 , _AOOccludeAll);
			half4 temp_output_182_0_g808 = ( ( ase_lightAtten * ( ( lerpResult36_g810 + ( ( saturate( ( ( dotResult82_g810 * ( 1.0 - temp_output_40_0_g810 ) ) + temp_output_40_0_g810 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g810 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g810 ) , 0.0 ) ) , _RimPower ) * _RimTransmissionIntensity * temp_output_84_0_g810 ) ) * temp_output_32_0_g810 ) ) * ase_lightColor ) ) * lerpResult183_g808 );
			...
			#ifdef UNITY_PASS_FORWARDBASE
				half4 staticSwitch250_g808 = ( temp_output_182_0_g808 + ( half4( indirectDiffuse53_g808 , 0.0 ) * temp_output_42_0_g808 * temp_output_161_0_g808 ) );
			#else
				half4 staticSwitch250_g808 = temp_output_182_0_g808;
			#endif
			float2 uv_EmissionMap = i.uv_texcoord * _EmissionMap_ST.xy + _EmissionMap_ST.zw;
			clip( alpha518 - _AlphaClip);
			c.rgb = ( staticSwitch250_g808 + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
/*ASEBEGIN
Version=18935
1920;0;1920;1029;5500.538;1082.827;3.989795;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;607;-5055.662,276.4733;Inherit;False;Property;_HighlightBlend;Highlight Blend;33;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;116;-1849.578,2423.963;Inherit;False;Property;_AOStrength;Ambient Occlusion Strength;11;0;Create;False;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;380;-1204.028,337.0532;Inherit;False;Property;_SpecularMultiplier;Specular Strength;48;0;Create;False;0;0;0;False;0;False;1;0.5;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;602;-1211.443,146.042;Inherit;True;Property;_SpecularMap;Specular  Map;43;0;Create;True;0;0;0;False;0;False;19;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;177;-708.1495,432.6585;Inherit;True;Property;_FlowMap;Flow Map;42;0;Create;True;0;0;0;False;0;False;19;None;None;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;591;-688.9429,353.1747;Inherit;False;Property;_SpecularPowerScale;Specular Smoothness;49;0;Create;False;0;0;0;False;0;False;2;2;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;263;-675.4739,1076.239;Inherit;False;Property;_RimPower;Rim Hardness;45;0;Create;False;0;0;0;False;0;False;4;2.5;1;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;539;-678.5594,926.0629;Inherit;False;Property;_Translucency;Translucency;53;0;Create;True;0;0;0;False;0;False;0;0.15;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=0862ED37C46E274D6440358C4CF98557DC31100A